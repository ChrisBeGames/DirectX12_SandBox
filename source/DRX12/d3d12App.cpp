...
void D3DApp::OnResize()
{
	...
	//	Flush before changing any resources. GPU needs to finish all the processes before resources can be affected.
	FlushCommandQueue();
...

{
	...
	// Try top create hardware device
...
void D3DApp::FlushCommandQueue()
{
	...
	// Wait until the GPU HAS COMPLETED COMMANS UP TO THIS FENCE POINT
